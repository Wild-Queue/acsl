...
/********************   CodeAnnot    ********************/
CodeAnnot::CodeAnnot(LogicPTreeAnnot *p1)
{
  logicptreeannot_ = p1;
...
/********************   SomeLoopAnnotations    ********************/
SomeLoopAnnotations::SomeLoopAnnotations(ListLogicPTreeAnnot *p1)
{
  listlogicptreeannot_ = p1;

}

SomeLoopAnnotations::SomeLoopAnnotations(const SomeLoopAnnotations & other)
{
  listlogicptreeannot_ = other.listlogicptreeannot_->clone();
...
{
  std::swap(listlogicptreeannot_, other.listlogicptreeannot_);

}

SomeLoopAnnotations::~SomeLoopAnnotations()
{
  delete(listlogicptreeannot_);
...
/********************   TypeSpecIntKeyWord    ********************/
TypeSpecIntKeyWord::TypeSpecIntKeyWord(INT p1)
{
  int_ = p1;
...
CVSpecAttribute_annotKeyWord::CVSpecAttribute_annotKeyWord(ATTRIBUTE_ANNOT p1)
{
  attribute_annot_ = p1;
