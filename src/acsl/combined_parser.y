...
%token          _LBRACK             /* [ */
%token          _SYMB_95            /* [| */
%token          _SYMB_85            /* \\Allocation */
%token          _SYMB_83            /* \\allocable */
%token          _SYMB_98            /* \\at */
%token          _SYMB_86            /* \\automatic */
%token          _SYMB_80            /* \\base_addr */
%token          _SYMB_81            /* \\block_length */
%token          _SYMB_78            /* \\dangling */
%token          _SYMB_87            /* \\dynamic */
%token          _SYMB_106           /* \\empty */
%token          _SYMB_67            /* \\exists */
%token          _SYMB_70            /* \\false */
%token          _SYMB_66            /* \\forall */
%token          _SYMB_84            /* \\freeable */
%token          _SYMB_79            /* \\fresh */
%token          _SYMB_111           /* \\from */
%token          _SYMB_55            /* \\ghost */
%token          _SYMB_64            /* \\in */
%token          _SYMB_77            /* \\initialized */
%token          _SYMB_108           /* \\inter */
%token          _SYMB_68            /* \\lambda */
%token          _SYMB_65            /* \\let */
%token          _SYMB_112           /* \\nothing */
%token          _SYMB_91            /* \\null */
%token          _SYMB_71            /* \\object_pointer */
%token          _SYMB_82            /* \\offset */
%token          _SYMB_97            /* \\old */
%token          _SYMB_103           /* \\pi */
%token          _SYMB_88            /* \\register */
%token          _SYMB_99            /* \\result */
%token          _SYMB_100           /* \\separated */
%token          _SYMB_89            /* \\static */
%token          _SYMB_69            /* \\true */
%token          _SYMB_105           /* \\type */
%token          _SYMB_104           /* \\typeof */
%token          _SYMB_90            /* \\unallocated */
%token          _SYMB_107           /* \\union */
%token          _SYMB_72            /* \\valid */
%token          _SYMB_74            /* \\valid_function */
%token          _SYMB_75            /* \\valid_index */
%token          _SYMB_76            /* \\valid_range */
%token          _SYMB_73            /* \\valid_read */
%token          _SYMB_109           /* \\with */
%token          _RBRACK             /* ] */
%token          _CARET              /* ^ */
%token          _CARETEQ            /* ^= */
%token          _DCARET             /* ^^ */
...
;
Annot : LogicPTreeAnnot { $$ = new acsl::CodeAnnot($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->annot_ = $$; }
...
Statement : _SEMI { $$ = new acsl::SemicolonStatement(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->statement_ = $$; }
  | Spec AnnotatedStmt { $$ = new acsl::SpecStatement($1, $2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->statement_ = $$; }
...
OptLoopAnnotations : /* empty */ { $$ = new acsl::NoLoopAnnotations(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->optloopannotations_ = $$; }
  | ListLogicPTreeAnnot { $$ = new acsl::SomeLoopAnnotations($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->optloopannotations_ = $$; }
;
...
Declaration : DeclSpecList DeclAndInitDeclAttrList _SEMI { $$ = new acsl::DeclSpecInitDecl($1, $2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->declaration_ = $$; }
  ...
  | Spec DeclSpecList DeclAndInitDeclAttrList _SEMI { $$ = new acsl::SpecDeclSpecInitDecl($1, $2, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->declaration_ = $$; }
  | Spec DeclSpecList _SEMI { $$ = new acsl::SpecDeclSpec($1, $2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->declaration_ = $$; }
...
TypeSpec : _KW_void { $$ = new acsl::TypeSpecVoidKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
  ...
  | T_INT { $$ = new acsl::TypeSpecIntKeyWord($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
  | _KW_long { $$ = new acsl::TypeSpecLongKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
  | _SYMB_54 { $$ = new acsl::TypeSpecInt64KeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
...
;
FunctionDef : Spec FunctionDefStart Block { $$ = new acsl::FunctionDefSpec($1, $2, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->functiondef_ = $$; }
...
CVSpec : T_CONST { $$ = new acsl::CVSpecConstKeyWord($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->cvspec_ = $$; }
  ...
  | _SYMB_55 { $$ = new acsl::CVSpecGhostKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->cvspec_ = $$; }
  | T_ATTRIBUTE_ANNOT { $$ = new acsl::CVSpecAttribute_annotKeyWord($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->cvspec_ = $$; }
;
...
Lexpr : /* empty */ { $$ = new acsl::NoLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | Lexpr _SYMB_59 Lexpr { $$ = new acsl::ImplLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | Lexpr _SYMB_60 Lexpr { $$ = new acsl::IffLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | Lexpr _SYMB_62 Lexpr { $$ = new acsl::BimpliesLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | Lexpr _SYMB_63 Lexpr { $$ = new acsl::BiffLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | Lexpr _SYMB_64 Lexpr { $$ = new acsl::InLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
...
;
LexprBinder : _SYMB_65 BoundedVar _EQ Lexpr _SEMI Lexpr { $$ = new acsl::LetBinderLexpr($2, $4, $6); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
  | _SYMB_66 Binders _SEMI Lexpr { $$ = new acsl::ForallBinderLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
  | _SYMB_67 Binders _SEMI Lexpr { $$ = new acsl::ExistBinderLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
  | _SYMB_68 Binders _SEMI Lexpr { $$ = new acsl::LambdaBinderLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
;
...
Lexpr3 : ListSTRING_LITERAL { std::reverse($1->begin(),$1->end()) ;$$ = new acsl::StringLexpr($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_69 { $$ = new acsl::TrueLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_70 { $$ = new acsl::FalseLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_71 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::PointerLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_72 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::ValidLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_73 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::ValidReadLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_74 _LPAREN Lexpr _RPAREN { $$ = new acsl::ValidFuncLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_75 OptLabel1 _LPAREN Lexpr _COMMA Lexpr _RPAREN { $$ = new acsl::ValidIndxLexpr($2, $4, $6); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_76 OptLabel1 _LPAREN Lexpr _COMMA Lexpr _COMMA Lexpr _RPAREN { $$ = new acsl::ValidRangeLexpr($2, $4, $6, $8); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_77 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::InitializedLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_78 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::DanglingLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_79 OptLabel2 _LPAREN Lexpr _COMMA Lexpr _RPAREN { $$ = new acsl::FreshLexpr($2, $4, $6); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_80 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::BaseAddrLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_81 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::BlockLengthLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_82 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::OffsetLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_83 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::AllocableLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_84 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::FreeableLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_85 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::AllocationLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_86 { $$ = new acsl::AutomaticLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_87 { $$ = new acsl::DynamicLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_88 { $$ = new acsl::RegisterLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_89 { $$ = new acsl::StaticLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_90 { $$ = new acsl::UnallocatedLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_91 { $$ = new acsl::NullLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | Lexpr3 _SYMB_92 Lexpr3 { $$ = new acsl::StarHatLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_95 LexprList _SYMB_96 { $$ = new acsl::SquaresPipeLexpr($2); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_97 _LPAREN Lexpr _RPAREN { $$ = new acsl::OldLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_98 _LPAREN Lexpr _COMMA LabelName _RPAREN { $$ = new acsl::AtLexpr($3, $5); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_99 { $$ = new acsl::ResultLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_100 _LPAREN ListLexpr _RPAREN { std::reverse($3->begin(),$3->end()) ;$$ = new acsl::SeparatedLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_103 { $$ = new acsl::PiLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_104 _LPAREN Lexpr _RPAREN { $$ = new acsl::TypeOfLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_105 _LPAREN TypeSpecOFTYPENAME _RPAREN { $$ = new acsl::TypeLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_105 _LPAREN TypeSpecOFTYPENAME ListStars _RPAREN { std::reverse($4->begin(),$4->end()) ;$$ = new acsl::TypeWithStarsLexpr($3, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_106 { $$ = new acsl::EmptyLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_107 _LPAREN LexprList _RPAREN { $$ = new acsl::UnionLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_108 _LPAREN LexprList _RPAREN { $$ = new acsl::InterLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _LBRACE Lexpr _SYMB_109 ListUpdateElt _RBRACE { std::reverse($4->begin(),$4->end()) ;$$ = new acsl::UpdateBraceLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
;
...
UpdateElt : ListPathElt _EQ Lexpr { std::reverse($1->begin(),$1->end()) ;$$ = new acsl::AnUpdateElt($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->updateelt_ = $$; }
  | ListPathElt _EQ _LBRACE _SYMB_109 ListUpdateElt _RBRACE { std::reverse($1->begin(),$1->end()) ; std::reverse($5->begin(),$5->end()) ;$$ = new acsl::UpdateEltWith($1, $5); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->updateelt_ = $$; }
;
...
CV : _KW_const { $$ = new acsl::ConstCV(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->cv_ = $$; }
  ...
  | _SYMB_55 { $$ = new acsl::GhostCV(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->cv_ = $$; }
;
...
Assigns : Zones { $$ = new acsl::AssignZone($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->assigns_ = $$; }
  | ListLexpr _SYMB_111 Zones { std::reverse($1->begin(),$1->end()) ;$$ = new acsl::AssignZoneFromZone($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->assigns_ = $$; }
;
Zones : ListLexpr { std::reverse($1->begin(),$1->end()) ;$$ = new acsl::SomeZone($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->zones_ = $$; }
  | _SYMB_112 { $$ = new acsl::NoZone(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->zones_ = $$; }
;
...
Annotation : LoopAnnotStack { $$ = new acsl::LoopAnnotation($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->annotation_ = $$; }
  ...
  | _SYMB_55 { $$ = new acsl::GhostAnnotation(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->annotation_ = $$; }
;
...
CKeyword : _KW_char { $$ = new acsl::CharKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->ckeyword_ = $$; }
  ...
  | _SYMB_89 { $$ = new acsl::StaticKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->ckeyword_ = $$; }
...
;
BSKeyword : _SYMB_83 { $$ = new acsl::SlashAllocableKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_85 { $$ = new acsl::SlashAllocationKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_86 { $$ = new acsl::SlashAutomaticKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_98 { $$ = new acsl::SlashAtKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_80 { $$ = new acsl::SlashBaseAddrKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_81 { $$ = new acsl::SlashBlockLengthKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_55 { $$ = new acsl::SlashGhostKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_87 { $$ = new acsl::SlashDynamicKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_106 { $$ = new acsl::SlashEmptyKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_70 { $$ = new acsl::SlashFalseKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_66 { $$ = new acsl::SlashForallKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_84 { $$ = new acsl::SlashFreeableKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_79 { $$ = new acsl::SlashFreshKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_111 { $$ = new acsl::SlashFromKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_108 { $$ = new acsl::SlashInterKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_68 { $$ = new acsl::SlashLambdaKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_65 { $$ = new acsl::SlashLetKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_112 { $$ = new acsl::SlashNothingKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_91 { $$ = new acsl::SlashNullKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_97 { $$ = new acsl::SlashOldKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_82 { $$ = new acsl::SlashOffsetKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_88 { $$ = new acsl::SlashRegisterKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_99 { $$ = new acsl::SlashResultKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_100 { $$ = new acsl::SlashSeparatedKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_69 { $$ = new acsl::SlashTrueKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_105 { $$ = new acsl::SlashTypeKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_104 { $$ = new acsl::SlashTypeofKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_107 { $$ = new acsl::SlashUnionKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_90 { $$ = new acsl::SlashUnallocatedKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_71 { $$ = new acsl::SlashObjectPointerKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_72 { $$ = new acsl::SlashValidKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_75 { $$ = new acsl::SlashValidIndexKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_76 { $$ = new acsl::SlashValidRangeKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_73 { $$ = new acsl::SlashValidReadKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_74 { $$ = new acsl::SlashValidFunctionKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_77 { $$ = new acsl::SlashInitializedKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_78 { $$ = new acsl::SlashDanglingKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
  | _SYMB_109 { $$ = new acsl::SlashWithKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->bskeyword_ = $$; }
;
Wildcard : AnyIdentifier { $$ = new acsl::WildCardAnyIdent($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_63 { $$ = new acsl::WildcardBIff(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  | _SYMB_62 { $$ = new acsl::WildcardBImplicate(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_67 { $$ = new acsl::WildcardExistsKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  | _GTEQ { $$ = new acsl::WildcardGreaterEq(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  | _SYMB_55 { $$ = new acsl::WildcardGhostKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_60 { $$ = new acsl::WildcardIff(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  | _SYMB_59 { $$ = new acsl::WildcardImplicate(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_95 { $$ = new acsl::WildcardLeftSquarePipe(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_103 { $$ = new acsl::WildcardPiKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_96 { $$ = new acsl::WildcardRightSquarePipe(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_92 { $$ = new acsl::WildcardMultHat(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
  ...
  | _SYMB_64 { $$ = new acsl::WildcardInKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->wildcard_ = $$; }
;
