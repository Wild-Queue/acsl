...
%token          _LBRACK           /* [ */
%token          _SYMB_60          /* \\automatic */
%token          _SYMB_61          /* \\dynamic */
%token          _SYMB_55          /* \\exists */
%token          _SYMB_58          /* \\false */
%token          _SYMB_54          /* \\forall */
%token          _SYMB_49          /* \\from */
%token          _SYMB_56          /* \\lambda */
%token          _SYMB_50          /* \\nothing */
%token          _SYMB_65          /* \\null */
%token          _SYMB_67          /* \\pi */
%token          _SYMB_62          /* \\register */
%token          _SYMB_66          /* \\separated */
%token          _SYMB_63          /* \\static */
%token          _SYMB_57          /* \\true */
%token          _SYMB_64          /* \\unallocated */
%token          _SYMB_59          /* \\valid */
%token          _RBRACK           /* ] */
%token          _CARET            /* ^ */
%token          _CARETEQ          /* ^= */
%token          _DCARET           /* ^^ */
...
TypeSpec : _KW_void { $$ = new acsl::TypeSpecVoidKeyWord(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
  ...
  | _KW_struct IdOrTypename _LBRACE StructDeclList _RBRACE { $$ = new acsl::StructIdBraces($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
  | _KW_struct _LBRACE StructDeclList _RBRACE { $$ = new acsl::StructBraces($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->typespec_ = $$; }
;
...
;
Block : _LBRACE BlockAttrs ListBlockElement _RBRACE { $$ = new acsl::ABlock($2, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->block_ = $$; }
;
...
Attr13 : Attr14 { $$ = $1; $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->attr_ = $$; }
  ...
  | Attr13 _LBRACK Attr _RBRACK { $$ = new acsl::ArrayAttr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->attr_ = $$; }
;
...
AssignExpr14 : AssignExpr15 { $$ = $1; $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->assignexpr_ = $$; }
  | AssignExpr14 _LBRACK ListExpression _RBRACK { std::reverse($3->begin(),$3->end()) ;$$ = new acsl::BracketsPostfixExpression($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->assignexpr_ = $$; }
...
Assigns : Zones { $$ = new acsl::AssignZone($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->assigns_ = $$; }
  | ListLexpr _SYMB_49 Zones { std::reverse($1->begin(),$1->end()) ;$$ = new acsl::AssignZoneFromZone($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->assigns_ = $$; }
;
Zones : ListLexpr { std::reverse($1->begin(),$1->end()) ;$$ = new acsl::SomeZone($1); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->zones_ = $$; }
  | _SYMB_50 { $$ = new acsl::NoZone(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->zones_ = $$; }
;
...
;
Lexpr : Lexpr _SYMB_51 Lexpr1 { $$ = new acsl::ImplLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | Lexpr _SYMB_52 Lexpr1 { $$ = new acsl::IffLexpr($1, $3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
...
;
LexprBinder : _SYMB_54 Binders _SEMI Lexpr { $$ = new acsl::ForallBinderLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
  | _SYMB_55 Binders _SEMI Lexpr { $$ = new acsl::ExistBinderLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
  | _SYMB_56 Binders _SEMI Lexpr { $$ = new acsl::LambdaBinderLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexprbinder_ = $$; }
;
...
;
Lexpr3 : _SYMB_57 { $$ = new acsl::TrueLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_58 { $$ = new acsl::FalseLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_59 OptLabel1 _LPAREN Lexpr _RPAREN { $$ = new acsl::ValidLexpr($2, $4); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_60 { $$ = new acsl::AutomaticLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_61 { $$ = new acsl::DynamicLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_62 { $$ = new acsl::RegisterLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_63 { $$ = new acsl::StaticLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_64 { $$ = new acsl::UnallocatedLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  | _SYMB_65 { $$ = new acsl::NullLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_66 _LPAREN ListLexpr _RPAREN { std::reverse($3->begin(),$3->end()) ;$$ = new acsl::SeparatedLexpr($3); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
  ...
  | _SYMB_67 { $$ = new acsl::PiLexpr(); $$->line_number = @$.first_line; $$->char_number = @$.first_column; result->lexpr_ = $$; }
